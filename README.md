...
<div align="center">
  ...
  <h2>Inspired from Sebastian Raschka</h2>
</div>

## **Overview**

This tutorial is aimed at coders interested in understanding the building blocks of large language models (LLMs), how LLMs work, and how to code them from the ground up in PyTorch. We will kick off this tutorial with an introduction to LLMs, recent milestones, and their use cases. Then, we will code a small GPT-like LLM, including its data input pipeline, core architecture components, and pretraining code ourselves. After understanding how everything fits together and how to pretrain an LLM, we will learn how to load pretrained weights and do instruction finetuning of the LLMs using open-source libraries.
...
Loading and utilizing pre-trained weights
...
<div align="center">
  **The code material uses the [LitGPT](https://github.com/Lightning-AI/litgpt) library.**
</div>
...
## **Contact**
For any queries, reach out to <a href="https://www.linkedin.com/in/kushagra-malani" target="_blank">Kushagra Malani</a>
